...
- Don't silently create fallback/placeholder data (e.g., inserting a row with a random UUID) — throw/assert instead when preconditions are not met, especially when middleware guarantees the precondition. Confidence: 0.65
